package ch.phastixtv.lobbysystem.util.configs;
...
public class ConfigurationUtil {
    ...
    public ConfigurationUtil(Lobbysystem lobbysystem, Location location, String root) {
        this.lobbysystem = lobbysystem;
        this.location = location;
        this.root = root;
    }

    public ConfigurationUtil(Lobbysystem lobbysystem, String root) {
        this(lobbysystem, null, root);
    }

    public void saveBlockLocation() {
        FileConfiguration config = lobbysystem.getConfig();
    ...
    public Block loadBlockLocation() {
        ...
        if(config.contains(root)) {
            ...
            int x = lobbysystem.getConfig().getInt(root + ".X"),
                    y = lobbysystem.getConfig().getInt(root + ".Y"),
                    z = lobbysystem.getConfig().getInt(root + ".Z");
    ...
    public Location loadLocation() {
        FileConfiguration config = Lobbysystem.getPlugin().getConfig();
        if (config.contains(root)) {
            World world = Bukkit.getWorld(config.getString(root + ".World"));
